...
<div class="wrapper">
	...
	<div>
		...
		<p>
			...
			<br />
			<br />
			I've barely ever found anything that doesn't capture my interest (except sports!). I grew up playing
			with a digital camcorder and Windows Movie Maker, and I focused on different forms of media production
